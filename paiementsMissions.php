...
<html>
	   ...
	   <header id="header" class="fixed-top">
		<div class="container">
		  ...
		  <div class="logo float-left">
			<h1 class="text-light"><a href="transitionco.php"><span>Projet Epoka</span></a></h1>
 ...
 <main id="main">
<?php
if(!isset($_SESSION['Sal_NoResponsable']) || $_SESSION['Sal_NoResponsable'] == 0) {
...
<div class="container">
	...
	<h2> Validation des missions de vos subordonnés </h2>
	<hr>
...
// On récupère tout le contenu de la table Mission
$reponse = $bdd->query("SELECT * FROM mission, salarie WHERE Sal_No = Mis_NoSalarie");   //AND	 Mis_No = '".$donnees['Mis_No']."';
...
// On affiche les données
    ...
    echo "<td> $donnees[Mis_dateDebut] </td>";
		...
		if($donnees['Mis_Valider'] == 1 ) {
			echo "<td> <p> Validée </p> </td>"; 
		}
		else {
			echo '<td> <a href="valider.php?id=' . $donnees['Mis_No'] . '" class="btn btn-outline-dark"> Valider </a> </td>';
		}
    echo "</tr>";
	}
